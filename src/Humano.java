	        ...
	        do{
	            do{
	                ...
	                if( tentativa[0] > 3 ||tentativa[0] < 1)
	                    System.out.println("Linha inválida, preencha novamente! É 1, 2 ou 3");
	            ...
	            do{
	                ...
	                if(tentativa[1] > 3 ||tentativa[1] < 1)
	                    System.out.println("Coluna inválida, preencha novamente! É 1, 2 ou 3");
	            ...
	            if(!checarTentativa(tentativa, tabuleiro))
	                System.out.println("Esse local já foi marcado. Preencha novamente!");
